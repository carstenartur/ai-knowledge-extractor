# ai-knowledge:optimize

**Full name:** `org.aiknowledge:ai-knowledge-maven-plugin:optimize`

**Phase:** `verify`

**Description:** Detects knowledge smells and writes ranked optimization suggestions.
